        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4 ">
            <div className="flex items-center gap-3">
              ...
              <span className="text-base font-semibold text-gray-900  hover:text-indigo-600  transition-colors duration-300">
                ONCHAINGM
              </span>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-gray-600  hover:text-indigo-500  transition-colors group"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Why OnChainGM? */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-gray-900 ">Why OnChainGM?</h3>
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2" aria-label="Footer navigation">
              <a className="flex items-center gap-2 text-gray-600  hover:text-indigo-600  transition-colors" href="/documentation.html">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a className="flex items-center gap-2 text-gray-600  hover:text-indigo-600  transition-colors" href="/why-onchaingm.html">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a className="flex items-center gap-2 text-gray-600  hover:text-indigo-600  transition-colors" href="/deploy">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.87999 7.71001L14.16 11.99L9.87999 16.27" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span>Deploy Contract</span>
              </a>
              <a className="flex items-center gap-2 text-gray-600  hover:text-indigo-600  transition-colors" href="/embed">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.87999 7.71001L14.16 11.99L9.87999 16.27" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span>Embed GM Button</span>
              </a>
              <a className="flex items-center gap-2 text-gray-600  hover:text-indigo-600  transition-colors" href="/referral-system.html">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.87999 7.71001L14.16 11.99L9.87999 16.27" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span>Referral System</span>
              </a>
              <a className="flex items-center gap-2 text-gray-600  hover:text-indigo-600  transition-colors" href="/community-guidelines.html">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.87999 7.71001L14.16 11.99L9.87999 16.27" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span>Community Guidelines</span>
              </a>
              <a className="flex items-center gap-2 text-gray-600  hover:text-indigo-600  transition-colors" href="/support.html">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.87999 7.71001L14.16 11.99L9.87999 16.27" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span>Support</span>
